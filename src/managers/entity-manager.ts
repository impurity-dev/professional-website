...
export class Column1Entity extends TransformNode {
    constructor(
        ...
        super('Column1', scene);
        const task = manager.addContainerTask('Column1 Task', '', 'objects/low-poly/', 'Column_1.obj');
    }
}
...
export class DetailsPlateLongEntity extends TransformNode {
    constructor(
        ...
        const task = manager.addContainerTask('DetailsPlateLong Task', '', 'objects/low-poly/', 'Details_Plate_Long.obj');
        // task.onSuccess = onSuccess(this);
