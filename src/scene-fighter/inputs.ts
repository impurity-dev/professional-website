...
export const controller = (props: { scene: BABYLON.Scene; events: events.Events }) => {
    ...
    scene.onBeforeRenderObservable.add(() => {
        ...
        const aimInputs = aim(scene, mouseState);
...
const aim = (scene: BABYLON.Scene, state: MouseState) => {
